...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/dns_checker

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/dns_checker: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.c} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/dns_checker ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/write.o: write.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 `pkg-config --cflags libcares` -std=c11  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/write.o write.c
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/dns_checker
